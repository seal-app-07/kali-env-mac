...
C. LightDM Greeter tuning
	•	Generate /etc/lightdm/lightdm.conf.d/50-gtk-greeter.conf
to ensure basic readability (font/AA)
...
impacket-*, crackmapexec (may vary), responder, smbclient,
metasploit-framework, bloodhound, neo4j, masscan, amass, httpx, naabu, etc.
